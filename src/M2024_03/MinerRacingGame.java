 ...
 * output data. Typically this streamcorresponds to display output or another
 * output destinationspecified by the host environment or user.
 * 
 * For simple stand-alone Java applications, a typical way to writea line of
 * output data is:
 * 
 * System.out.println(data)
 * 
 * 
 * See the println methods in class PrintStream. See
